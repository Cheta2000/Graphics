...
class Draw {
    ...
    drawScene() {
        ...
        // uruchamiamy stencil test
        this.gl.disable(this.gl.DEPTH_TEST);
        this.gl.enable(this.gl.STENCIL_TEST);
        // kolor tla
        this.gl.clearColor(0.0, 0.0, 0.0, 1.0);
        this.gl.clearStencil(0);
        // czyscimy stencil i color, co daje nam czarne tlo
        this.gl.clear(this.gl.COLOR_BUFFER_BIT | this.gl.STENCIL_BUFFER_BIT);
        // przy jakims niezdanym tescie zostawiamy to co jest, przy zdanym zmieniamy
        this.gl.stencilOp(this.gl.KEEP, this.gl.KEEP, this.gl.REPLACE);
        // wlaczamy mozliwosc zapisu
        this.gl.stencilMask(255);
        // funkcja zawsze przechodzi, wstawiamy 1 tam gdzie jest siatka
        this.gl.stencilFunc(this.gl.ALWAYS, 1, 255);
        // rysujemy siatke, aby odpowiednio wypelnic bufor stencil
        ...
        this.gl.depthFunc(this.gl.GL_LESS);
        // czysciemy depth i kolor zeby po narysowaniu siatki wrocil stary kolor tla
        this.gl.clear(this.gl.COLOR_BUFFER_BIT | this.gl.DEPTH_BUFFER_BIT);
        // teraz rysujemy tylko tam gdzie w buforze jest 1, czyli tam gdzie byla rysowana siatka
        this.gl.stencilFunc(this.gl.EQUAL, 1, 255);
        // blokujemy mozliwosc zapisu
        ...
        // teraz rysujemy tam gdzie w buforze jest 0, tam gdzie nie bylo siatki
        this.gl.stencilFunc(this.gl.EQUAL, 0, 255);

        // nie zapisujemy nic do bufora
        this.gl.stencilMask(0);
        this.gl.useProgram(this.program);
